      ...
      <section className="py-10 sm:py-16 lg:py-16">
            <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8 z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="mt-3 text-xl leading-relaxed text-dirt md:mt-4">Your contribution directly addresses these critical issues, providing immediate relief and long-term support to Appalachian communities in need"</p>
                </div>
